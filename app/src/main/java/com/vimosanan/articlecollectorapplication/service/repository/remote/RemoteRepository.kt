package com.vimosanan.articlecollectorapplication.service.repository.remote
...
class RemoteRepository @Inject constructor(private val api: ApiInterface) {

    suspend fun loadArticlesFromRemote() : Result<List<Article>>{
